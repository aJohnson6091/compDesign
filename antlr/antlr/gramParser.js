...
var symbolicNames = [ null, "SEMI", "WHILE", "LP", "RP", "IF", "ELSE", "RETURN", 
                      ...
                      "RELOP", "EQ", "PLUS", "MULOP", "MINUS", "CMA", "TYPE", 
                      "STRINGCONST", "PRINT", "INPUT", "OPEN", "READ", "WRITE", 
                      "CLOSE", "ID", "WHITESPACE", "COMMENT", "STRINGCONSTANT" ];
...
gramParser.CLOSE = 28;
gramParser.ID = 29;
gramParser.WHITESPACE = 30;
gramParser.COMMENT = 31;
gramParser.STRINGCONSTANT = 32;
...
gramParser.prototype.notexp = function() {
    ...
    try {
        ...
        case gramParser.CLOSE:
        case gramParser.ID:
        case gramParser.STRINGCONSTANT:
            this.enterOuterAlt(localctx, 2);
            this.state = 125;
            this.rel();
            break;
...
FactorContext.prototype.STRINGCONSTANT = function() {
    return this.getToken(gramParser.STRINGCONSTANT, 0);
};
...
gramParser.prototype.factor = function() {
    ...
    try {
        ...
        case 5:
            this.enterOuterAlt(localctx, 5);
            this.state = 172;
            this.match(gramParser.STRINGCONSTANT);
            break;
